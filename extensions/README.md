...
Use `/compact set <mode>` to save one of `programmatic`, `cached`, `cached-handoff`, `cached-handoff-tooltraces`, `cached-summary-tooltraces`, or `vanilla`.
